    ...
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="container mx-auto px-6 md:px-8 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-xl mx-auto">
              Discover how Antwrite transforms your writing experience with
              these core features.
            </p>
          </div>
                  ...
                  >
                    {modelNames.map((name, i) => {
                      ...
                      return (
                        ...
                        >
                          {i === proIndex && (
                            <span className="absolute top-1 right-1 bg-accent text-accent-foreground text-[10px] px-1 rounded">
                              Pro
                            </span>
                          )}
      ...
      <footer className="w-full border-t border-border bg-background/80 backdrop-blur-sm py-4 mt-8">
        <div className="container mx-auto px-6 md:px-8 lg:px-12 flex items-center justify-between text-sm text-muted-foreground">
          <span>
            © {new Date().getFullYear()} Antwrite. All rights reserved.
          </span>
          <Button
            variant="outline"
            size="icon"
