...
export const LogoLinkedIn = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
...
export const LogoTwitter = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
...
export const LogoMicrosoft = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    style={{ color: 'currentcolor' }}
  >
    <path d="M7.462 0H0v7.19h7.462V0zM16 0H8.538v7.19H16V0zM7.462 8.211H0V16h7.462V8.211zM16 8.211H8.538V16H16V8.211z" fill="currentColor" />
  </svg>
);
