...
export const VersionHeader = ({
  ...
  const relativeTimeString = formatDistance(
    new Date(currentDoc.createdAt),
    new Date(),
    { addSuffix: true },
  );
  ...
  return (
    <TooltipProvider>
      <div className="relative border-b border-border backdrop-blur-sm overflow-hidden">
        <div className="px-4 py-2.5 flex items-center justify-between">
          {' '}
          {/* Simplified to single row */}
