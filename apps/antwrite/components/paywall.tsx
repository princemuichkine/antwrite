...
export const displayPlans = [
  {
    ...
    stripePriceId:
      process.env.STRIPE_PRO_MONTHLY_PRICE_ID || 'monthly_placeholder',
    annual: false,
  },
  {
    displayName: 'Annual',
    ...
    discount: 30,
    stripePriceId:
      process.env.STRIPE_PRO_YEARLY_PRICE_ID || 'yearly_placeholder',
    annual: true,
  },
];
...
export function Paywall({
  ...
  const handleUpgrade = async (planName: string, annual = false) => {
    ...
    console.log(
      `Initiating subscription upgrade to plan: ${planName}, annual: ${annual}`,
    );
            ...
            <div className="grow">
              <DialogHeader className="mb-6 text-left">
                ...
                <DialogDescription className="text-sm mb-6">
                  Subscribe to unlock Claude Opus, AI trained on the way you
                  write, and{' '}
                ...
                {displayPlans.map((plan) => (
                  ...
                  >
                    ...
                    <div className="mt-8">
                      <Button
                        onClick={() =>
                          handleUpgrade(plan.planName, plan.annual)
                        }
                        disabled={isLoading}
                        className="w-full"
                        size="lg"
